...
| Feature Name           | Extended Propagation Delay Support Low-Band                                |
|------------------------|----------------------------------------------------------------------------|
...
PRACH preamble format 1 enables cell range extension up to 100 km.
...
# 9 Engineering Guidelines for Extended Propagation Delay Support Low-Band
