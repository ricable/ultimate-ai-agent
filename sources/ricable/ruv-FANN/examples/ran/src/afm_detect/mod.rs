use crate::afm_detect::tensor_ops::{
    DType, Device, Result, Tensor, Module, VarBuilder, VarMap, 
    var_builder_from_varmap
};
...
impl AFMDetector {
    ...
    pub fn new(
        ...
        let vb = var_builder_from_varmap(&var_map, DType::F32, &device);
