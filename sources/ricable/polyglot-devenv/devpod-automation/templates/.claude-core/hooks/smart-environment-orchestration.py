...
class SmartEnvironmentOrchestrator:
    ...
    def __init__(self, project_root: Path):
        ...
        # DevPod container adaptation - state files in .claude directory
        self.claude_dir = project_root / ".claude"
        self.claude_dir.mkdir(parents=True, exist_ok=True)
        self.orchestration_state_file = self.claude_dir / "orchestration_state.json"
        self.usage_analytics_file = self.claude_dir / "environment_usage.jsonl"
